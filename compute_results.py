...
df_mudan = pd.read_csv("final_results_UCB_2/60000/MUDAN_2.csv")
df_mudar = pd.read_csv("final_results_UCB_2/60000/MUDAR_2.csv")
#df_vcg = pd.read_csv("final_results/60000/VCG.csv")
df_gidm = pd.read_csv("final_results_UCB_2/60000/GIDM_2.csv")
...
print(final_results)
path = "final_results_UCB_2/60000/results/"
...
final_results = pd.concat(results).reset_index(drop=True)
print(final_results)
final_results.to_csv(path+"basic_best_results_2.csv")