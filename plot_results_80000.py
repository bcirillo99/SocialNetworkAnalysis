...
df_mudan = pd.read_csv("results_first/80000/MUDAN.csv")
df_mudar = pd.read_csv("results_first/80000/MUDAR.csv")
#df_vcg = pd.read_csv("results_first/80000/VCG.csv")
df_gidm = pd.read_csv("results_first/80000/GIDM.csv")
