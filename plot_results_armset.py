...
for t in ["20000","80000"]:
    ...
    df = pd.read_csv(path+"MUDAR_2.csv")
    ...
    revenue_bayes_ucb_prior_normal = []

    revenue_ucb_page = []
    revenue_bayes_ucb_page = []
    revenue_bayes_ucb_prior_page = []

    revenue_ucb_degree = []
    revenue_bayes_ucb_degree = []
    revenue_bayes_ucb_prior_degree = []

    revenue_ucb_vote = []
    revenue_bayes_ucb_vote = []
    revenue_bayes_ucb_prior_vote = []

    revenue_ucb_s_deg = []
    revenue_bayes_ucb_s_deg = []
    revenue_bayes_ucb_prior_s_deg = []


    revenue_ucb_s_thresh = []
    revenue_bayes_ucb_s_thresh = []
    revenue_bayes_ucb_prior_s_thresh = []

    revenue_ucb_s_clos = []
    revenue_bayes_ucb_s_clos = []
    revenue_bayes_ucb_prior_s_clos = []
    ...
    for k in listk:
        ...
        revenue_bayes_ucb_prior_degree.append(revenue[2])
        ...
        revenue_bayes_ucb_prior_page.append(revenue[2])
        ...
        revenue_bayes_ucb_prior_vote.append(revenue[2])
        ...
        revenue_bayes_ucb_prior_s_deg.append(revenue[2])
        ...
        revenue_bayes_ucb_prior_s_thresh.append(revenue[2])
        ...
        revenue_bayes_ucb_prior_s_clos.append(revenue[2])
    ...
    axs[0].plot(listk, revenue_bayes_ucb_prior_degree, label = 'Bayesian UCB prior')
    axs[0].set_xlabel('k')
    ...
    axs[1].plot(listk, revenue_bayes_ucb_prior_page, label = 'Bayesian UCB prior')
    axs[1].set_xlabel('k')
    ...
    axs[2].plot(listk, revenue_bayes_ucb_prior_vote, label = 'Bayesian UCB prior')
    axs[2].set_xlabel('k')
    ...
    axs[3].plot(listk, revenue_bayes_ucb_prior_s_deg, label = 'Bayesian UCB prior')
    axs[3].set_xlabel('k')
    ...
    axs[4].plot(listk, revenue_bayes_ucb_prior_s_thresh, label = 'Bayesian UCB prior')
    axs[4].set_xlabel('k')
    ...
    axs[5].plot(listk, revenue_bayes_ucb_prior_s_clos, label = 'Bayesian UCB prior')
    axs[5].set_xlabel('k')
    ...
    plt.savefig(path+'armset_chart_2.png')
    #plt.show()
    ...
    axs[1].plot(listk, revenue_bayes_ucb_normal, label = 'Normal')
    axs[1].plot(listk, revenue_bayes_ucb_s_deg, label = 's. degree')
    axs[1].plot(listk, revenue_bayes_ucb_s_thresh, label = 's. threshold')
    axs[1].plot(listk, revenue_bayes_ucb_s_clos, label = 's. closeness')
    axs[1].set_xlabel('k')
    axs[1].set_xticks(listk, listk)
    axs[1].set_ylabel('Revenue')
    ...
    axs[2].plot(listk, revenue_bayes_ucb_prior_degree, label = 'Degree')
    axs[2].plot(listk, revenue_bayes_ucb_prior_page, label = 'PageRank')
    axs[2].plot(listk, revenue_bayes_ucb_prior_vote, label = 'VoteRank')
    axs[2].plot(listk, revenue_bayes_ucb_prior_s_deg, label = 's. degree')
    axs[2].plot(listk, revenue_bayes_ucb_prior_s_thresh, label = 's. threshold')
    axs[2].plot(listk, revenue_bayes_ucb_prior_s_clos, label = 's. closeness')
    axs[2].set_xlabel('k')
    axs[2].set_xticks(listk, listk)
    axs[2].set_ylabel('Revenue')
    axs[2].set_title("Bayesian UCB prior")
    axs[2].legend()

    fig.tight_layout(pad=0.5)
    plt.savefig(path+'bandit_charts_2.png')
