...
class SocNetMec_TH_mudan:
    
    def __init__(self, G, T, k, auctions, arms_set,gaussian_dist=None):
        self.G = G
        self.T = T
        self.k = k
        self.auctions = auctions
...
class SocNetMec_EPS_mudan:
    
    def __init__(self, G, T, k, auctions, arms_set,eps):
        self.G = G
        self.T = T
        self.k = k
        self.auctions = auctions
