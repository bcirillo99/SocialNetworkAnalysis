...
for t in ["20000","40000"]:
    ...
    #df_mudan = pd.read_csv("_1final_results_UCB_GIDM/20000/MUDAN_1.csv")
    #df_mudar = pd.read_csv("final_results_UCB/"+t+"/MUDAR_1.csv")
    #df_vcg = pd.read_csv("final_results/20000/VCG_1.csv")
    df_gidm = pd.read_csv("final_results_UCB_GIDM/"+t+"/GIDM_1.csv")
    ...
    #print(final_results)
    path = "final_results_UCB_GIDM/"+t+"/results/"
