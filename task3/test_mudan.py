...
if __name__ == '__main__':
    seller_net, reports, bids, G = create_auction(30)
    ...
    for i in tqdm(range(100)):
        for node in bids.keys():
            realbid = bids[node]
            # Caso Base
            allocations, payments = auction_mudan(5, seller_net, reports, bids)
            ...
            allocations, payments = auction_mudan(5, seller_net, reports, new_bids)
