...
# A riceve una ricompensa dal seller
...
print(auction(3, seller_net, reports, bids))
# ({'S': True, 'B': False, 'C': False, 'D': False, 'H': False, 'E': False, 'T': False, 'F': False, 'A': False, 'G': False}, {'A': 0, 'B': 0, 'C': 0, 'D': 0, 'E': 0, 'F': 0, 'G': 0, 'S': 30, 'T': 0, 'H': 0})
# ({'b': True, 'a': True, 'd': True, 'c': False}, {'a': -105, 'b': 5, 'c': 0, 'd': 5})
